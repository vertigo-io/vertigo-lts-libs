...
<#if currentLayout = 'table'>
	...
	<#if controlLayout_tablecolspan?exists >
    		<#assign columnCount = controlLayout_currentColumnCount + parameters.dynamicAttributes.get('colspan')?default(1)?number />	
...
<#elseif parameters.dynamicAttributes.get('layout') = 'none'>
