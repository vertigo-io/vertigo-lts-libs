...
public final class UserAuthentification implements Entity {
	...
	private final StoreVAccessor<io.vertigo.struts2.data.domain.users.ApplicationUser> usrIdAccessor = new StoreVAccessor<>(io.vertigo.struts2.data.domain.users.ApplicationUser.class, "ApplicationUser");
	 ...
	 */
	public StoreVAccessor<io.vertigo.struts2.data.domain.users.ApplicationUser> applicationUser() {
